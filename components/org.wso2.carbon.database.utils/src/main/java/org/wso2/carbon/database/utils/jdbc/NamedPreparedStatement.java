...
public class NamedPreparedStatement implements PreparedStatement {
    ...
    public NamedPreparedStatement(Connection connection, String sqlQuery, Map<String, Integer> repetition)
        ...
        prepareSqlQuery(connection, sqlQuery, repetition, null);
    }
    ...
    public NamedPreparedStatement(Connection connection, String sqlQuery, Map<String, Integer> repetition,
        ...
        prepareSqlQuery(connection, sqlQuery, repetition, returningColumnName);
    }
    ...
    private String prepareSqlQuery(Connection connection, String sqlQuery, Map<String, Integer> repetition,
        ...
        if (returningColumnName == null) {
            ...
            preparedStatement = connection.prepareStatement(sqlQuery, new String[]
