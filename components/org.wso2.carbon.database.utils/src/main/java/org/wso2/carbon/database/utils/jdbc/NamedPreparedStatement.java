...
public class NamedPreparedStatement implements PreparedStatement {
     ...
     * @param connection Database connection to be used.
     * @param sqlQuery   Underlying SQL query.
     * @param columnName Name of the unique column to be returned upon query success.
     * @throws SQLException SQL Exception.
     */
    public NamedPreparedStatement(Connection connection, String sqlQuery, String columnName) throws SQLException {

        this(connection, sqlQuery, new HashMap<String, Integer>(), columnName);
    }
     ...
     * @param sqlQuery   Underlying SQL query.
     * @param repetition Repetition of given index.
     * @param columnName Name of the column to be returned upon query success.
     * @throws SQLException SQL Exception.
     */
    public NamedPreparedStatement(Connection connection, String sqlQuery, Map<String, Integer> repetition,
        ...
        preparedStatement = connection.prepareStatement(sqlQuery, new String[]
                {JdbcUtils.getConvertedAutoGeneratedColumnName(connection.getMetaData()
                        .getDatabaseProductName(), columnName)});
    }
